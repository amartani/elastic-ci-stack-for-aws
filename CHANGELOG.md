...
- Smaller docker networks allow 16x as many docker-compose networks [#968](https://github.com/buildkite/elastic-ci-stack-for-aws/pull/968) (@ouranos)
- Add support for additional ARM/Graviton instance types [#981](https://github.com/buildkite/elastic-ci-stack-for-aws/pull/981) [#979](https://github.com/buildkite/elastic-ci-stack-for-aws/pull/979)  (@toothbrush) (@yob)
...
- autoscaling:DescribeAutoScalingInstances can only be applied to all resources [#989](https://github.com/buildkite/elastic-ci-stack-for-aws/pull/989) (@jeremiahsnapp)
...
- Update agent version to v3.43.0 [#990](https://github.com/buildkite/pull/990) (@moskyb)
